...
export default function Layout({ children, currentPageName }) {
  ...
  const navigation = [
    ...
    { name: 'Personnel', href: createPageUrl('Personnel'), icon: Users, roles: ['super_admin', 'admin', 'academic_head', 'admin_supervisor'] },
    ...
    { name: 'Reports', href: createPageUrl('Reports'), icon: TrendingUp, roles: ['super_admin', 'broker_admin', 'academic_head'] },
