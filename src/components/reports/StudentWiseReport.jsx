...
export default function StudentWiseReport({ transactions, dateLabel }) {
                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {rows.length === 0 ? (
                                ...
                                <tr key={row.student_id} className={`border-b border-gray-100 hover:bg-gray-50 ${idx % 2 !== 0 ? 'bg-gray-50/40' : ''}`}>
